...
- Comment on [this issue](https://github.com/githubteacher/sep-19-developers/issues/2) to become a collaborator on the project
- Practice making an issue [in the issues tab of the class repository](https://github.com/githubteacher/sep-19-developers/issues).
